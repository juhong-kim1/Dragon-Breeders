...
namespace SmokeTest
{
    public static class GPGSIds
    {
         ...
         */
        public const string
            achievement_achievementtoincrement = "CgkIz5f37JMBEAIQAA"; // <GPGSID>

        public const string achievement_achievementtounlock = "CgkIz5f37JMBEAIQAQ"; // <GPGSID>
        public const string achievement_achievementtoreveal = "CgkIz5f37JMBEAIQAg"; // <GPGSID>
        ...
        public const string
            leaderboard_leaders_in_smoketesting = "CgkIz5f37JMBEAIQAw"; // <GPGSID>
    }
}